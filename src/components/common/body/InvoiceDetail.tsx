...
import { deleteInvoice } from "../../../libs/storage";
...
const InvoiceDetail = () => {
  ...
  const [showDelete, setShowDelete] = useState(false); // controls modal
      ...
      <div className="max-w-[730px] mx-auto flex flex-col gap-4">
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              className="px-6 py-3 rounded-full text-sm font-bold
              text-white bg-[#7C5DFA] hover:bg-[#9277FF]
              transition-colors hover:cursor-pointer"
            >
              Mark as Paid
            </button>
        ...
        {/* Invoice Body */}
        <div
          className="bg-white dark:bg-[#1E2139] rounded-xl px-6 md:px-8
          py-8 md:py-10 shadow-sm flex flex-col gap-8"
        >
        ...
        >
          <button
            onClick={() => navigate(`/invoice/${invoice.id}/edit`)}
            className="text-sm font-bold text-[#7E88C3] hover:text-[#7C5DFA] transition-colors"
          >
            Edit
          </button>
          <button
